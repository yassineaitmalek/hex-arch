...
public class AuditRequestFilter extends OncePerRequestFilter {
    ...
    private static final String TEMPLATE = "FINISHED PROCESSING : METHOD = {}; REQUEST URI = {}; REQUEST PAYLOAD = {}; RESPONSE CODE = {}; TIME TAKEN = {}ms";
    ...
    private String getRequest(byte[] contentAsByteArray, String characterEncoding)
